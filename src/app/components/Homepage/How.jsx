...
const How = () => {
  return (
    <div className='w-full px-7 md:px-28 py-7 flex-col my-20 items-center flex'>
        <h1 className='text-4xl text-center mt-5  text-white mb-8 font-semibold'>How It Works? <br />
         <span className='text-xl md:text-5xl text-center   text-white mb-8 font-semibold'> Your Gateway to Advanced Crypto Investment</span></h1>
