...
const Retail = () => {
  return (
    <div className='w-full px-16 md:px-28 py-7 flex-col my-20 items-center flex'>
        <p className='font-semibold text-lg'>FUEL YOUR GROWTH</p>
        <h1 className='text-4xl mt-5 md:text-7xl text-white mb-5 font-semibold'>For Retail Investors</h1>
