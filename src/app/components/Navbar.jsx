...
const Navbar = () => {
  ...
  return (
    <nav className="fixed w-full z-10 py-3 nav">
      <div className="max-w-screen-xl flex md:flex-row items-center justify-between mx-auto px-4 relative">
        {" "}
        ...
        <Link href="/">
          <div className="flex items-center  gap-4 rtl:space-x-reverse cursor-pointer">
            <Image
              ...
              height={100}
            ></Image>
            <span className="self-center text-2xl  md:text-4xl font-bold whitespace-nowrap text-white">
              NEBULA
            </span>
          </div>
        </Link>
        ...
        >
          ...
          <ul className="font-medium  flex flex-col left-0 p-4 md:p-0 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse">
            ...
            <li onClick={toggleNavbar}>
              <a target="_blank" href="https://t.me/+K2gODipwtbo3MDVh">
                <span className="block font-bold text-white rounded md:hover:bg-transparent md:dark:hover:bg-transparent nav-link">
                  CONTACT US
                </span>
              </a>
